...
```
```{r echo=FALSE, dpi=96, message=FALSE, warning=FALSE, error=FALSE}
  ggplot(data = CST7Data, aes(x = CST6Data$date, y = CST7Data$cdd__cnt_gt_0, group=CST7Data$name, color=CST7Data$name)) + geom_line() + geom_point() + facet_wrap(~ CST7Data$name) +
      labs(x = "Year",
...
## Precipitation
For the departure-based metrics, a new set of stations collecting precipitation is needed. Notice the additional station discovered.
```{r message=FALSE, warning=FALSE, error=FALSE}
...
CSP1Data$pcpn_in_cnt_ge_1.0
```
```{r echo=FALSE, dpi=96, message=FALSE, warning=FALSE, error=FALSE}
ggplot(data = CSP1Data, aes(x = CSP1Data$date, y = CSP1Data$pcpn_in_cnt_ge_1.0,  color=CSP1Data$name)) + geom_line() + geom_point() + facet_wrap(~ CSP1Data$name) +
      labs(x = "Year",
...
CSP2Data$pcpn_in_cnt_ge_2.0
```
```{r echo=FALSE, dpi=96, message=FALSE, warning=FALSE, error=FALSE}
ggplot(data = CSP2Data, aes(x = CSP2Data$date, y = CSP2Data$pcpn_in_cnt_ge_2.0, group=CSP2Data$name, color=CSP2Data$name)) + geom_line() + geom_point() + facet_wrap(~ CSP2Data$name) +
      labs(x = "Year",
...
CSP4Data$snow_in_cnt_ge_0.1
```
```{r echo=FALSE, dpi=96, message=FALSE, warning=FALSE, error=FALSE}
  ggplot(data = CSP4Data, aes(x = CSP4Data$date, y = CSP4Data$snow_in_cnt_ge_0.1, group=CSP4Data$name, color=CSP4Data$name)) + geom_line() + geom_point() + facet_wrap(~ CSP4Data$name) +
      labs(x = "Year",
...
CSP5Data$snow_in_cnt_ge_3.0
```
```{r echo=FALSE, dpi=96, message=FALSE, warning=FALSE, error=FALSE}
  ggplot(data = CSP5Data, aes(x = CSP5Data$date, y = CSP5Data$snow_in_cnt_ge_3.0, group=CSP5Data$name, color=CSP5Data$name)) + geom_line() + geom_point() + facet_wrap(~ CSP5Data$name) +
      labs(x = "Year",
...
CSP6Data$snow_in_cnt_ge_5.0
```
```{r echo=FALSE, dpi=96, message=FALSE, warning=FALSE, error=FALSE}
  ggplot(data = CSP6Data, aes(x = CSP6Data$date, y = CSP6Data$snow_in_cnt_ge_5.0, group=CSP6Data$name, color=CSP6Data$name)) + geom_line() + geom_point() + facet_wrap(~ CSP6Data$name) +
      labs(x = "Year",
